...
// Services
import { getStolenVehiclesService } from '@/app/modules/vehicle/infrastructure/services'
...
export const FilterStolenDataSkeleton = ({ limit = 5 }: { limit: number }) => {
  return (
    <>
...
export const FilterStolenData = async ({
  skip,
  limit,
  page,
}: {
  ...
  const results = await getStolenVehiclesService({
    skip,
    limit,
  })
